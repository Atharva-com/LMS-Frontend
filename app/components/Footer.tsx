    ...
    return (
        <footer className="">
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                <div
                    className="flex flex-col items-center gap-4 rounded-lg dark:bg-slate-800 bg-[#39c1f3] p-6 shadow-lg sm:flex-row sm:justify-between"
                >
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <ul className="mt-8 space-y-4 text-sm">
                            ...
                            <li>
                                <a className="text-gray-700 transition hover:text-gray-700/75" href="/"> My Account </a>
                            </li>

                            <li>
                                <a className="text-gray-700 transition hover:text-gray-700/75" href="/"> Course DashBoard </a>
                            </li>
                        </ul>
                    </div>
